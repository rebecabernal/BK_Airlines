            ...
            <tbody>
                @foreach ($pastFlights as $pastFlight)
                    <tr class="row" id="{{$pastFlight->id}}">
                        ...
                        <td>{{ $pastFlight->origin }}</td>
                        <td>{{ $pastFlight->arrival }}</td>
                        <td>{{ $pastFlight->plane->seats }}</td>
                        <td>{{ $pastFlight->reserved }}</td>
                        <td>{{ $pastFlight->plane->seats - $pastFlight->reserved }}</td>
                        <td>
                            @if ($pastFlight->plane && ($pastFlight->reserved < $pastFlight->plane->seats))
